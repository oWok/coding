...
//    varargFunction(*nums)
    ...
    putIceCreams("손", "수박바", "슈퍼콘", "쿠크앤", "메로나", "슈크르바")
...
//    println("basket => ${basket.toList().joinToString("\n")}")
    ...
    //basket["원종우"] = "ㅇ하자 2020년 5월 7일에" // 가능
    //checkoutBasket["원종우"] = "ㅇ하자 2020년 5월 7일에" // err

    putIceCreams("손", "엄청 이쁨") // 불변뷰라도 가변뷰가 변경된다면 바뀜 -> 중요함

    val bonusIceCreams = arrayOf("빠삐코", "포도맛", "홍삼맛", "인삼맛", "20200507")
    putIceCreams("원종우", "ㅇ", "70500202", *bonusIceCreams, "대구") //배열 앞에 * 있으면 배열이 펼처지는 되는 효과 / * -> 펼침 연산자
